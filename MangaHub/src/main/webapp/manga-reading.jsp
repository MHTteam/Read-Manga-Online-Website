            ...
            <div class="container">
                ...
                <div class="chapter-navigator" >
                    <div class="anime__details__btn">
                        <c:choose>
                            <c:when test="${not empty requestScope.previousChapter}">
                                <a href="manga?action=read&mangaID=${requestScope.chapter.mangaID}&chapterID=${requestScope.previousChapter.chapterID}">Previous</a>
                            </c:when>    
                            <c:otherwise>
                                <a class="disabled" href="manga?action=read&mangaID=${requestScope.chapter.mangaID}&chapterID=${requestScope.previousChapter.chapterID}">Previous</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="anime__details__btn">
                        <c:choose>
                            <c:when test="${not empty requestScope.nextChapter}">
                                <a href="manga?action=read&mangaID=${requestScope.chapter.mangaID}&chapterID=${requestScope.nextChapter.chapterID}" >Next</a>
                            </c:when>    
                            <c:otherwise>
                                <a class="disabled" href="manga?action=read&mangaID=${requestScope.chapter.mangaID}&chapterID=${requestScope.nextChapter.chapterID}" >Next</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
